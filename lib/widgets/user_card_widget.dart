...
class UserCardWidget extends StatelessWidget {
  ...
  const UserCardWidget({Key? key, this.userInfo, this.matchingInfo})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    return matchingInfo == null
        ? buildUserCard(context)
        : buildMatchingCard(context);
  }

  Card buildMatchingCard(BuildContext context) {
    return Card(
      color: matchingInfo?.entrepreneur?.userRole == 'reviewer'
      ...
      child: Row(
        children: [
          Padding(
              ...
              child: matchingInfo?.entrepreneur?.imageProfilePath != null
                  ? CircleAvatar(
                      radius: 50,
                      backgroundImage: NetworkImage(
                          matchingInfo!.entrepreneur!.imageProfilePath!))
          ...
          Column(
            ...
            children: [
              Padding(
                padding: const EdgeInsets.all(16.0),
                child: Text(
                    '${matchingInfo?.entrepreneur?.firstName} ${matchingInfo?.entrepreneur?.lastName}',
                    style: Theme.of(context).textTheme.titleMedium),
              ),
              Row(
                children: [
                  matchingInfo?.entrepreneur?.productExpertise?.food
                              ?.freshFood ==
                          true
                      ? const ChipGenerator(
              ...
              Row(
                children: [
                  matchingInfo?.entrepreneur?.productExpertise?.cosmetic
                              ?.hairCosmetic ==
                          true
                      ? const ChipGenerator(
              ...
              Row(
                children: [
                  matchingInfo?.entrepreneur?.productExpertise?.cloth?.shirt ==
                          true
                      ? const ChipGenerator(
                          label: 'Shirt, Blouse, T-shirt, Jacket',
                          color: Color(0xFF5f65d3))
                      : Container(),
                  matchingInfo?.entrepreneur?.productExpertise?.cloth
                              ?.trouser ==
                          true
                      ? const ChipGenerator(
                          label: 'Trousers, Pants', color: Color(0xFF5f65d3))
                      : Container(),
                  matchingInfo?.entrepreneur?.productExpertise?.cloth?.cap ==
                          true
                      ? const ChipGenerator(
                          label: 'Cap, Hat', color: Color(0xFF5f65d3))
                      : Container(),
                  matchingInfo?.entrepreneur?.productExpertise?.cloth?.scarf ==
                          true
                      ? const ChipGenerator(
                          label: 'Scarf', color: Color(0xFF5f65d3))
                      : Container(),
                  matchingInfo?.entrepreneur?.productExpertise?.cloth?.skirt ==
                          true
                      ? const ChipGenerator(
                          label: 'Skirt', color: Color(0xFF5f65d3))
                      : Container(),
                  matchingInfo?.entrepreneur?.productExpertise?.cloth?.shoes ==
                          true
                      ? const ChipGenerator(
                          label: 'Shoes, Boot, Sneaker',
                          color: Color(0xFF5f65d3))
                      : Container(),
                  matchingInfo?.entrepreneur?.productExpertise?.cloth?.belt ==
                          true
                      ? const ChipGenerator(
                  ...
                  matchingInfo?.entrepreneur?.productExpertise?.cloth
                      ...
                      : Container(),
                  matchingInfo?.entrepreneur?.productExpertise?.cloth?.bag ==
                          true
                      ? const ChipGenerator(
              ...
              Row(
                children: [
                  matchingInfo?.entrepreneur?.productExpertise?.service
                              ?.accomodation ==
                          true
                      ? const ChipGenerator(
                  ...
                  matchingInfo?.entrepreneur?.productExpertise?.service
                      ...
                      : Container(),
                  matchingInfo?.entrepreneur?.productExpertise?.service?.cafe ==
                          true
                      ? const ChipGenerator(
